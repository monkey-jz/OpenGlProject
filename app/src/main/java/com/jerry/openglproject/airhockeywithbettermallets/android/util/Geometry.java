package com.jerry.openglproject.airhockeywithbettermallets.android.util;
...
public class Geometry {
    ...
    public static boolean intersects(Sphere sphere,Ray ray) {
        return distanceBextween(sphere.center,ray) < sphere.radius;
    }

    private static float distanceBextween(Point center, Ray ray) {
